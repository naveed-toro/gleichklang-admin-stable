 ...
 */
public class ConfirmActiveInactivePopup extends Popup
{

	private  final EmailDomainMappingRepository repository;
	public ConfirmActiveInactivePopup(EmailDomainMapping mapping, EmailDomainMappingRepository repository)
	{
		super(I18N.ACTIVEINACTIVEEMAILPMAPPINGPOPUP_CAPTION_TITLE.msg());
	...
	private void activeInactiveMapping(EmailDomainMapping mapping)
	{
		try
		{
			repository.updateActiveEmailDomainMapping(!mapping.isActive(),mapping.getId());
			close();
		}
		catch (Exception e)
		{
