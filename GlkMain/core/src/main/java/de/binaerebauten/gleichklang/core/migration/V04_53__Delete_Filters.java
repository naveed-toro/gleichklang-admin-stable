...
public class V04_53__Delete_Filters implements SpringJdbcMigration
{
	@Override
	public void migrate(JdbcTemplate jdbcTemplate)
	{
		...
		final SqlRowSet rowSet = jdbcTemplate.queryForRowSet("SELECT id FROM filter WHERE DTYPE IN ('CancellationPolicyAcceptedFilter', 'CommunityRulesAcceptedFilter', 'GeneralTermsAcceptedFilter');");
		while (rowSet.next())
		{
