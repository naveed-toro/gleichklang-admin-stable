 ...
 */
public class AudioUploadComponent extends CustomComponent
{
    ...
    private final AudioUploadCallback callBack;
    ...
    public AudioUploadComponent(MediaGallery gallery, MediaUploadFile mediaUploadFile, AudioUploadCallback callback)
    {
        ...
        setCompositionRoot(createUploadAudioComponent(file));
    }

    private Component createUploadAudioComponent(MediaUploadFile mediaUploadFile)
    {
