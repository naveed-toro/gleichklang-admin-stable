...
@Entity
public class PaymentTypeFilter extends EnumFilter<PaymentType>
{
	@XmlAttribute
	@Column(name = "enum_value")
	@Enumerated(EnumType.STRING)
	@NotNull
	private PaymentType enumValue;
	
	@Override
	public PaymentType getEnumValue()
	{
		return enumValue;
	}
	
	@Override
	public void setEnumValue(PaymentType enumValue)
	{
