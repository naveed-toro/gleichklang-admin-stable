...
DROP TABLE IF EXISTS conversations_contact_lists;
...
DROP TABLE IF EXISTS media_gallery_invisible_relationship;
...
DROP TABLE IF EXISTS unzer_charge;
DROP TABLE IF EXISTS unzer_customer;
