...
DROP SCHEMA IF EXISTS gk_small;
CREATE SCHEMA gk_small;
USE gk_small;
ALTER DATABASE gk_small
DEFAULT COLLATE utf8_unicode_ci;


CREATE TABLE `compactiveuser` (
...
CREATE TABLE `compadportalrecipient` (
...
CREATE TABLE `compaffiliate_promotion` (
  `owner`            VARCHAR(75)
                     COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `compaffiliate_promotion_refund` (
  `owner`                VARCHAR(75)
                         COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `compcircularletter` (
  `title`                 VARCHAR(255)
                          COLLATE latin1_german2_ci          DEFAULT NULL,
  `subject`               VARCHAR(70)
                          COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `compext_adjektive` (
  `as_1e`                         TINYINT(3) UNSIGNED                DEFAULT NULL,
...
CREATE TABLE `compext_freundschaft` (
...
CREATE TABLE `compext_gesellschaft` (
...
CREATE TABLE `compext_kritische_lebensereignisse` (
...
CREATE TABLE `compext_partnerschaft` (
...
CREATE TABLE `compext_persoenlichkeit` (
...
CREATE TABLE `compext_stoerbarkeit` (
  `st_1`                          TINYINT(3) UNSIGNED                DEFAULT NULL,
  `st_2`                          TINYINT(3) UNSIGNED                DEFAULT NULL,
  `st_3`                          TINYINT(3) UNSIGNED                DEFAULT NULL,
  `st_4`                          TINYINT(3) UNSIGNED                DEFAULT NULL,
...
CREATE TABLE `compkritische_lebensereignisse` (
  `v1`         TINYINT(3) UNSIGNED                DEFAULT NULL,
  `v3`         TINYINT(3) UNSIGNED                DEFAULT NULL,
  `v7`         TINYINT(3) UNSIGNED                DEFAULT NULL,
  `v12`        TINYINT(3) UNSIGNED                DEFAULT NULL,
...
CREATE TABLE `compmail_additionaldata` (
...
CREATE TABLE `compmail_atomcondition` (
...
CREATE TABLE `compmail_campaign` (
...
CREATE TABLE `compmail_campaign_category` (
...
CREATE TABLE `compmail_category` (
...
CREATE TABLE `compmail_category_condlist` (
...
CREATE TABLE `compmail_conditionlist` (
...
CREATE TABLE `compmail_condlist_atomcond` (
  `condlist`      VARCHAR(75)          DEFAULT NULL,
  `atomcondition` VARCHAR(75)          DEFAULT NULL,
...
CREATE TABLE `compmail_dataentry` (
...
CREATE TABLE `compmatch_pair_info` (
...
CREATE TABLE `compmatch_participant_info` (
  `matching_search_domain_info` VARCHAR(75)
                                COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `compmatch_searchdomain_info` (
  `match_searchdomain`          VARCHAR(255)
                                COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `compmatch_select_info` (
  `matching_search_domain_info` VARCHAR(75)
                                COLLATE latin1_german2_ci          DEFAULT NULL,
  `match_searchdomain`          VARCHAR(255)
                                COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `compmatch_statistic_info` (
  `matching_search_domain_info` VARCHAR(75)
                                COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `compnewsletterrecipient` (
  `mail`       VARCHAR(255)
               COLLATE latin1_german2_ci          DEFAULT NULL,
  `no`         VARCHAR(75)
               COLLATE latin1_german2_ci NOT NULL DEFAULT '',
...
CREATE TABLE `comppartnerschaft` (
  `p1_1`       TINYINT(3) UNSIGNED                DEFAULT NULL,
  `p5_1`       TINYINT(3) UNSIGNED                DEFAULT NULL,
  `p6_1`       TINYINT(3) UNSIGNED                DEFAULT NULL,
  `p7_1`       TINYINT(3) UNSIGNED                DEFAULT NULL,
...
CREATE TABLE `comppayment_break` (
...
CREATE TABLE `comppayment_event` (
  `transaction_id` VARCHAR(75)
                   COLLATE latin1_german2_ci          DEFAULT NULL,
  `eventmethod`    CHAR(2)
                   COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `comppayment_offer` (
...
CREATE TABLE `comppayment_transaction` (
  `participant_id`                          VARCHAR(75)
                                            COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `comppayment_userinfo` (
  `participant_id`   VARCHAR(75)
                     COLLATE latin1_german2_ci          DEFAULT NULL,
...
CREATE TABLE `comppersoenlichkeit` (
  `pk_10_a`     TINYINT(3) UNSIGNED                DEFAULT NULL,
  `pk_17_i`     TINYINT(3) UNSIGNED                DEFAULT NULL,
  `pk_19_v`     TINYINT(3) UNSIGNED                DEFAULT NULL,
  `pk_20_f`     TINYINT(3) UNSIGNED                DEFAULT NULL,
...
CREATE TABLE `compproband_socio_economics` (
  `schulabschluss`                VARCHAR(255)
                                  COLLATE latin1_german2_ci          DEFAULT NULL,
  `in_partnerschaft`              TINYINT(3) UNSIGNED                DEFAULT NULL,
  `partnerschaft_dauer`           MEDIUMINT(9)                       DEFAULT NULL,
...
CREATE TABLE `compregion_addresslocation` (
...
CREATE TABLE `compregion_adresslocation` (
  `adrloc_street`                VARCHAR(128)         DEFAULT NULL,
  `adrloc_hnumber`               VARCHAR(10)          DEFAULT NULL,
  `adrloc_city`                  VARCHAR(128)         DEFAULT NULL,
  `adrloc_zip`                   VARCHAR(20)          DEFAULT NULL,
...
CREATE TABLE `compregion_assignment` (
...
CREATE TABLE `compregion_basesearch` (
  `reg_active`          TINYINT(3) UNSIGNED  DEFAULT NULL,
...
CREATE TABLE `compregion_geonameszip` (
...
CREATE TABLE `compregion_searchrestr` (
  `reg_notice`         TEXT,
  `owner`              VARCHAR(75)          DEFAULT NULL,
  `no`                 VARCHAR(75) NOT NULL DEFAULT '',
  `type`               VARCHAR(30)          DEFAULT NULL,
...
CREATE TABLE `compteilnehmerfilterinfo` (
...
CREATE TABLE `compundeliveredmail` (
  `mail`             VARCHAR(255)
                     COLLATE latin1_german2_ci          DEFAULT NULL,
  `no`               VARCHAR(75)
                     COLLATE latin1_german2_ci NOT NULL DEFAULT '',
...
CREATE TABLE `compunsolicitedmail` (
  `mail`       VARCHAR(255)
               COLLATE latin1_german2_ci          DEFAULT NULL,
  `no`         VARCHAR(75)
               COLLATE latin1_german2_ci NOT NULL DEFAULT '',
...
CREATE TABLE `compuser` (
  ...
  `mailunblocked_ip`                        VARCHAR(100)
                                            COLLATE latin1_german2_ci          DEFAULT NULL,
  `softwaretest_mail`                       VARCHAR(255)
                                            COLLATE latin1_german2_ci          DEFAULT NULL,
  `softwaretest_pw`                         VARCHAR(255)
                                            COLLATE latin1_german2_ci          DEFAULT NULL,
  `softwaretest_mail_new`                   VARCHAR(255)
                                            COLLATE latin1_german2_ci          DEFAULT NULL,
  PRIMARY KEY (`no`),
...
ALTER TABLE gk_small.compzipcity
  DROP PRIMARY KEY;
ALTER TABLE gk_small.compfreund
  ADD f_auswandern_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.compfreund
  ADD f_bildung_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.compfreund
  ADD f_gesleb_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.compfreund
  ADD f_mr_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.compfreund
  ADD f_polyamor VARCHAR(50) NULL;
ALTER TABLE gk_small.compfreund
  ADD f_zusleb_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_auswandern_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_bildung_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_gesleb_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_monogam VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_mr_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_polyamor VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_region_umzug TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.comppartner
  ADD p_reise_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.comppartner
  ADD p_zusleb_praef VARCHAR(50) NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_anpassen TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_anpassen_done TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_anpassen_done_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_anpassen_done_p TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_anpassen_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_anpassen_p TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_beratung_done_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_beratung_done_p TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_beratung_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_beratung_p TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_kommentieren TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_kommentieren_done TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_kommentieren_done_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_kommentieren_done_p TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_kommentieren_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD suchkriterien_kommentieren_p TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD vermittlung_komplettpaket TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD vermittlung_komplettpaket_done TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD vermittlung_komplettpaket_done_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD vermittlung_komplettpaket_done_p TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD vermittlung_komplettpaket_f TINYINT(3) UNSIGNED NULL;
ALTER TABLE gk_small.compuser
  ADD vermittlung_komplettpaket_p TINYINT(3) UNSIGNED NULL;

SELECT 'creation of tables finished';

SELECT 'creation of indexes';

USE gleichklang_migration;
...
CALL CREATE_INDEX('active_user_idx', 'compactiveuser', 'user');
CALL CREATE_INDEX('break_owner_idx', 'comppayment_break', 'break_owner');
CALL CREATE_INDEX('comppayment_transaction_idx', 'comppayment_transaction', 'participant_id');
CALL CREATE_INDEX('compaussehen_idx', 'compaussehen', 'owner');
CALL CREATE_INDEX('compfreund_idx', 'compfreund', 'owner');
CALL CREATE_INDEX('compfreundschaft_idx', 'compfreundschaft', 'owner');
CALL CREATE_INDEX('compftext_idx', 'compftext', 'owner');
CALL CREATE_INDEX('compgesellschaft_idx', 'compgesellschaft', 'owner');
CALL CREATE_INDEX('comphobby_v_idx', 'comphobby_v', 'owner');
CALL CREATE_INDEX('comppartner_idx', 'comppartner', 'owner');
CALL CREATE_INDEX('comppersoenlichkeit_idx', 'comppersoenlichkeit', 'owner');
CALL CREATE_INDEX('compperson_idx', 'compperson', 'owner');
CALL CREATE_INDEX('compptext_idx', 'compptext', 'owner');
CALL CREATE_INDEX('comppartnerschaft_idx', 'comppartnerschaft', 'owner');

CALL CREATE_INDEX('comppayment_break_owner', 'comppayment_break', 'break_owner');


SELECT 'creation of indexes finished';

DROP TABLE IF EXISTS gleichklang_migration.users;
CREATE TABLE gleichklang_migration.users AS
  SELECT *
  FROM
    (SELECT cu.*
     FROM gleichklang_migration.compuser AS cu
       JOIN gleichklang_migration.comppayment_transaction AS ct
         ON ct.participant_id = cu.no
     WHERE ct.subscription_begin < NOW() AND ct.subscription_end > NOW()
     LIMIT 2000) AS t1
  UNION
  (SELECT cu.*
   FROM gleichklang_migration.compuser AS cu
     JOIN gleichklang_migration.comppayment_transaction AS ct
       ON ct.participant_id = cu.no
   WHERE ct.subscription_begin > NOW() OR ct.subscription_end < NOW()
   LIMIT 1000);

CREATE INDEX compuser__index
  ON gleichklang_migration.users (no);

INSERT INTO gk_small.compuser
  SELECT *
  FROM gleichklang_migration.users;
CREATE INDEX compuser__index
  ON gk_small.compuser (no);
SELECT 'compuser finished';



INSERT INTO gk_small.compactiveuser
  SELECT ca.*
  FROM gleichklang_migration.compactiveuser AS ca
    JOIN gleichklang_migration.users AS u
      ON ca.user = u.no COLLATE latin1_german2_ci;

SELECT 'compactiveuser finished';

INSERT INTO gk_small.compadportalrecipient
  SELECT *
  FROM
    gleichklang_migration.compadportalrecipient
  WHERE
    no > '695'
  LIMIT 1000;
SELECT 'compadportalrecipient finished';

INSERT INTO gk_small.compcircularletter
  SELECT *
  FROM
    gleichklang_migration.compcircularletter
  WHERE changedate > '2015-04-01'
  LIMIT 1000;

SELECT 'compcircularletter finished';


INSERT INTO gk_small.compmatch_participant_info
  SELECT *
  FROM
    gleichklang_migration.compmatch_participant_info
  WHERE
    participant > '695' AND
    participant < '720'
  LIMIT 1000;

SELECT 'compmatch_participant_info finished';


INSERT INTO gk_small.compmatch_searchdomain_info
  SELECT *
  FROM
    gleichklang_migration.compmatch_searchdomain_info
  WHERE changedate > '2015-04-01'
  LIMIT 1000;

SELECT 'compmatch_searchdomain_info finished';

INSERT INTO gk_small.compmatch_statistic_info
  SELECT *
  FROM
    gleichklang_migration.compmatch_statistic_info
  WHERE changedate > '2015-04-01'
  LIMIT 1000;

SELECT 'compmatch_statistic_info finished';


INSERT INTO gk_small.compnewsletterrecipient
  SELECT *
  FROM
    gleichklang_migration.compnewsletterrecipient
  WHERE no > '695' AND
        no < '720'
  LIMIT 1000;

SELECT 'compnewsletterrecipient finished';


INSERT INTO gk_small.comppayment_event
  SELECT *
  FROM
    gleichklang_migration.comppayment_event
  WHERE changedate > '2015-04-01'
  LIMIT 1000;

SELECT 'comppayment_event finished';


INSERT INTO gk_small.comppayment_offer
  SELECT *
  FROM
    gleichklang_migration.comppayment_offer;

SELECT 'comppayment_offer finished';

INSERT INTO gk_small.comppayment_break
  SELECT t.*
  FROM
    gleichklang_migration.comppayment_break AS t
    JOIN gleichklang_migration.users AS u
      ON t.break_owner = u.no
                         COLLATE latin1_german2_ci
  LIMIT 1000;

SELECT 'comppayment_break finished';


INSERT INTO gk_small.comppayment_transaction
  SELECT t.*
  FROM
    gleichklang_migration.comppayment_transaction AS t
    JOIN
    gleichklang_migration.users AS u
      ON t.participant_id = u.no;

SELECT 'comppayment_transaction finished';

INSERT INTO gk_small.compundeliveredmail
  SELECT DISTINCT m.*
  FROM gk_small.compuser AS u RIGHT JOIN
    gleichklang_migration.compundeliveredmail AS m
      ON u.mail = m.mail
  WHERE u.no > '695';

SELECT 'compundeliveredmail finished';


INSERT INTO gk_small.compuseractivity
  SELECT *
  FROM
    gleichklang_migration.compuseractivity
  WHERE
    user > '695' AND
    changedate > '2015-04-01'
  LIMIT 1000;
SELECT 'compuseractivity finished';

INSERT INTO gk_small.compaffiliate_promotion
  SELECT *
  FROM
    gleichklang_migration.compaffiliate_promotion
  LIMIT 1000;
SELECT 'compaffiliate_promotion finished';

INSERT INTO gk_small.compaffiliate_promotion_refund
  SELECT *
  FROM
    gleichklang_migration.compaffiliate_promotion_refund
  LIMIT 1000;
SELECT 'compaffiliate_promotion_refund finished';

INSERT INTO gk_small.compaussehen
  SELECT t.*
  FROM gleichklang_migration.compaussehen AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'compaussehen finished';

INSERT INTO gk_small.compext_adjektive
  SELECT *
  FROM
    gleichklang_migration.compext_adjektive
  WHERE owner > '695'
  LIMIT 1000;
SELECT 'compext_adjektive finished';

INSERT INTO gk_small.compext_freundschaft
  SELECT *
  FROM
    gleichklang_migration.compext_freundschaft
  WHERE owner > '695'
  LIMIT 1000;
SELECT 'compext_freundschaft finished';

INSERT INTO gk_small.compext_gesellschaft
  SELECT *
  FROM
    gleichklang_migration.compext_gesellschaft
  WHERE owner > '695'
  LIMIT 1000;
SELECT 'compext_gesellschaft finished';

INSERT INTO gk_small.compext_hobby_e
  SELECT *
  FROM gleichklang_migration.compext_hobby_e
  WHERE owner > '695'
  LIMIT 1000;
SELECT 'compext_hobby_e finished';


INSERT INTO gk_small.compext_kritische_lebensereignisse
  SELECT *
  FROM
    gleichklang_migration.compext_kritische_lebensereignisse
  WHERE owner > '695'

  LIMIT 1000;
SELECT 'compext_kritische_lebensereignisse finished';

INSERT INTO gk_small.compext_partnerschaft
  SELECT *
  FROM
    gleichklang_migration.compext_partnerschaft
  WHERE
    owner > '695'
  LIMIT 1000;
SELECT 'compext_partnerschaft finished';

INSERT INTO gk_small.compext_persoenlichkeit
  SELECT *
  FROM
    gleichklang_migration.compext_persoenlichkeit
  WHERE
    owner > '695'
  LIMIT 1000;
SELECT 'compext_persoenlichkeit finished';

INSERT INTO gk_small.compext_stoerbarkeit
  SELECT *
  FROM
    gleichklang_migration.compext_stoerbarkeit
  WHERE owner > '695'
  LIMIT 1000;
SELECT 'compext_stoerbarkeit finished';

INSERT INTO gk_small.compffoto
  SELECT *
  FROM gleichklang_migration.compffoto
  WHERE owner > '695'
  LIMIT 10;
SELECT 'compffoto finished';

INSERT INTO gk_small.compfreund
  SELECT t.*
  FROM gleichklang_migration.compfreund AS t
    JOIN gleichklang_migration.users AS u ON t.owner = u.no;
SELECT 'compfreund finished';

INSERT INTO gk_small.compfreundschaft
  SELECT t.*
  FROM
    gleichklang_migration.compfreundschaft AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'compfreundschaft finished';

INSERT INTO gk_small.compftext
  SELECT t.*
  FROM gleichklang_migration.compftext AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;
SELECT 'compftext finished';

INSERT INTO gk_small.compgesellschaft
  SELECT t.*
  FROM
    gleichklang_migration.compgesellschaft AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'compgesellschaft finished';

INSERT INTO gk_small.comphobby_v
  SELECT t.*
  FROM gleichklang_migration.comphobby_v AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'comphobby_v finished';


INSERT INTO gk_small.comppartner
  SELECT t.*
  FROM gleichklang_migration.comppartner AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;
SELECT 'comppartner finished';

INSERT INTO gk_small.comppartnerschaft
  SELECT t.*
  FROM
    gleichklang_migration.comppartnerschaft AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'comppartnerschaft finished';

INSERT INTO gk_small.comppersoenlichkeit
  SELECT t.*
  FROM
    gleichklang_migration.comppersoenlichkeit AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'comppersoenlichkeit finished';

INSERT INTO gk_small.compperson
  SELECT t.*
  FROM gleichklang_migration.compperson AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'compperson finished';

INSERT INTO gk_small.comppfoto
  SELECT *
  FROM gleichklang_migration.comppfoto
  WHERE owner > '695'
  LIMIT 10;
SELECT 'comppfoto finished';

INSERT INTO gk_small.compproband_socio_economics
  SELECT *
  FROM
    gleichklang_migration.compproband_socio_economics
  LIMIT 1000;
SELECT 'compproband_socio_economics finished';


INSERT INTO gk_small.compptext
  SELECT t.*
  FROM gleichklang_migration.compptext AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;

SELECT 'compptext finished';

INSERT INTO gk_small.compregion_addresslocation
  SELECT *
  FROM
    gleichklang_migration.compregion_addresslocation
  WHERE owner > '695'

  LIMIT 1000;
SELECT 'compregion_addresslocation finished';

INSERT INTO gk_small.compteilnehmerfilterinfo
  SELECT *
  FROM
    gleichklang_migration.compteilnehmerfilterinfo
  WHERE owner > '695'

  LIMIT 1000;
SELECT 'compteilnehmerfilterinfo finished';

SELECT 'starting messages';

INSERT INTO gk_small.compmessage
  SELECT *
  FROM gleichklang_migration.compmessage
...
INSERT INTO gk_small.compmessage
  SELECT m2.*
  FROM gk_small.compmessage AS m1
    JOIN gleichklang_migration.compmessage AS m2
...
INSERT INTO gk_small.compuser
  SELECT u1.*
  FROM gk_small.compmessage AS m1
    JOIN gleichklang_migration.compuser AS u1
      ON m1.teilnehmer = u1.no OR m1.recipient = u1.no
  WHERE m1.no NOT IN (SELECT no
                      FROM gk_small.compmessage)
  GROUP BY u1.no;

SELECT 'compmessage finished. ';
...
DROP TABLE IF EXISTS gk_small.tmp_compvorschlag;
CREATE TEMPORARY TABLE gk_small.tmp_compvorschlag
  AS SELECT
       DISTINCT
       rubrik,
       suchender,
       ...
       singlesided,
       selstate,
       NULL AS match_participant_info,
       NULL AS match_admin_info,
       visibility_fotos,
       current_phonenumber
     FROM gleichklang_migration.compvorschlag AS v
       JOIN gleichklang_migration.users AS u
         ON u.no = v.suchender OR u.no = v.vorschlag
       JOIN gleichklang_migration.users AS u2
         ON u2.no = v.vorschlag AND v.suchender = u.no
     LIMIT 1000;

INSERT INTO gk_small.compvorschlag
SELECT DISTINCT
  v.rubrik,
  v.suchender,
  v.vorschlag,
  ...
  NULL AS match_admin_info,
  v.visibility_fotos,
  v.current_phonenumber
FROM gk_small.tmp_compvorschlag as t JOIN gleichklang_migration.compvorschlag AS v ON v.gegenvorschlag = t.no;
# INSERT INTO gk_small.compmessage
#   SELECT *
#   FROM gleichklang_migration.compmessage
#   WHERE (sender > '695'sender < '720') OR
#         ((recipient > '695'recipient < '720')
#          AND
#          (teilnehmer > '695'teilnehmer < '720'));
#
# INSERT INTO gk_small.compmessage
#   SELECT m2.*
#   FROM gk_small.compmessage AS m1 JOIN gleichklang_migration.compmessage AS m2
#       ON m1.reply_message = m2.no
#   WHERE m2.no NOT IN (SELECT no
#                       FROM gk_small.compmessage);
#
# INSERT INTO gk_small.compmessage
#   SELECT m2.*
...
-- suchender > '695'suchender < '720' and vorschlag > '695'vorschlag < '720' limit 10;
