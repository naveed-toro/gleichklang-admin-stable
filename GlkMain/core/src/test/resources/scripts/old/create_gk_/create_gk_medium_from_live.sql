DROP SCHEMA IF EXISTS gk_medium;
CREATE SCHEMA gk_medium;
USE gk_medium;
ALTER DATABASE gk_medium
...
ALTER TABLE gk_medium.compzipcity
  DROP PRIMARY KEY;
ALTER TABLE gk_medium.compfreund
...
ALTER TABLE gk_medium.comppartner
...
ALTER TABLE gk_medium.compuser
...
INSERT INTO gk_medium.compuser
  SELECT *
  FROM gleichklang_migration.users;
CREATE INDEX compuser__index
  ON gk_medium.compuser (no);
SELECT 'compuser finished';


INSERT INTO gk_medium.compactiveuser
  SELECT ca.*
...
INSERT INTO gk_medium.compadportalrecipient
  SELECT *
  FROM
...
INSERT INTO gk_medium.compcircularletter
  SELECT *
  FROM
...
INSERT INTO gk_medium.compmatch_participant_info
  SELECT *
  FROM
...
INSERT INTO gk_medium.compmatch_searchdomain_info
  SELECT *
  FROM
...
INSERT INTO gk_medium.compmatch_statistic_info
  SELECT *
  FROM
...
INSERT INTO gk_medium.compnewsletterrecipient
  SELECT *
  FROM
...
INSERT INTO gk_medium.comppayment_event
  SELECT *
  FROM
...
INSERT INTO gk_medium.comppayment_offer
  SELECT *
  FROM
...
INSERT INTO gk_medium.comppayment_break
  SELECT t.*
  FROM
...
INSERT INTO gk_medium.comppayment_transaction
  SELECT t.*
  FROM
...
INSERT INTO gk_medium.compundeliveredmail
  SELECT DISTINCT m.*
  FROM gk_medium.compuser AS u RIGHT JOIN
...
INSERT INTO gk_medium.compuseractivity
  SELECT *
  FROM
...
INSERT INTO gk_medium.compaffiliate_promotion
  SELECT *
  FROM
...
INSERT INTO gk_medium.compaffiliate_promotion_refund
  SELECT *
  FROM
...
INSERT INTO gk_medium.compaussehen
  SELECT t.*
...
INSERT INTO gk_medium.compext_adjektive
  SELECT *
  FROM
...
INSERT INTO gk_medium.compext_freundschaft
  SELECT *
  FROM
...
INSERT INTO gk_medium.compext_gesellschaft
  SELECT *
  FROM
...
INSERT INTO gk_medium.compext_hobby_e
  SELECT *
...
INSERT INTO gk_medium.compext_kritische_lebensereignisse
  SELECT *
  FROM
...
INSERT INTO gk_medium.compext_partnerschaft
  SELECT *
  FROM
...
INSERT INTO gk_medium.compext_persoenlichkeit
  SELECT *
  FROM
...
INSERT INTO gk_medium.compext_stoerbarkeit
  SELECT *
  FROM
...
INSERT INTO gk_medium.compffoto
  SELECT *
...
INSERT INTO gk_medium.compfreund
  SELECT t.*
...
INSERT INTO gk_medium.compfreundschaft
  SELECT t.*
  FROM
...
INSERT INTO gk_medium.compftext
  SELECT t.*
...
INSERT INTO gk_medium.compgesellschaft
  SELECT t.*
  FROM
...
INSERT INTO gk_medium.comphobby_v
  SELECT t.*
...
INSERT INTO gk_medium.comppartner
  SELECT t.*
...
INSERT INTO gk_medium.comppartnerschaft
  SELECT t.*
  FROM
...
INSERT INTO gk_medium.comppersoenlichkeit
  SELECT t.*
  FROM
...
INSERT INTO gk_medium.compperson
  SELECT t.*
...
INSERT INTO gk_medium.comppfoto
  SELECT *
...
INSERT INTO gk_medium.compproband_socio_economics
  SELECT *
  FROM
...
INSERT INTO gk_medium.compptext
  SELECT t.*
...
INSERT INTO gk_medium.compregion_addresslocation
  SELECT *
  FROM
...
INSERT INTO gk_medium.compteilnehmerfilterinfo
  SELECT *
  FROM
...
INSERT INTO gk_medium.compvorschlag
  SELECT
    DISTINCT
    rubrik,
    suchender,
...
# INSERT INTO gk_medium.compmessage
#   SELECT m2.*
#   FROM gk_medium.compmessage AS m1 JOIN gleichklang_migration.compmessage AS m2
#       ON m1.reply_message = m2.no
