DROP SCHEMA IF EXISTS gk_large;
CREATE SCHEMA gk_large;
USE gk_large;
ALTER DATABASE gk_large
...
ALTER TABLE gk_large.compzipcity
  DROP PRIMARY KEY;
ALTER TABLE gk_large.compfreund
...
ALTER TABLE gk_large.comppartner
...
CREATE TABLE gleichklang_migration.users AS
  ...
  FROM
    (SELECT cu.*
     ...
     WHERE ct.subscription_begin < NOW() AND ct.subscription_end > NOW()) AS t1
  UNION
  (SELECT cu.*
   FROM gleichklang_migration.compuser AS cu
     JOIN gleichklang_migration.comppayment_transaction AS ct
...
INSERT INTO gk_large.compuser
  SELECT *
  FROM gleichklang_migration.users;
CREATE INDEX compuser__index
  ON gk_large.compuser (no);
SELECT 'compuser finished';


INSERT INTO gk_large.compactiveuser
  SELECT ca.*
...
INSERT INTO gk_large.compadportalrecipient
  SELECT *
  FROM
...
INSERT INTO gk_large.compcircularletter
  SELECT *
  FROM
...
INSERT INTO gk_large.compmatch_participant_info
  SELECT *
  FROM
...
INSERT INTO gk_large.compmatch_searchdomain_info
  SELECT *
  FROM
...
INSERT INTO gk_large.compmatch_statistic_info
  SELECT *
  FROM
...
INSERT INTO gk_large.compnewsletterrecipient
  SELECT *
  FROM
...
INSERT INTO gk_large.comppayment_event
  SELECT *
  FROM
...
INSERT INTO gk_large.comppayment_offer
  SELECT *
  FROM
...
INSERT INTO gk_large.comppayment_break
  SELECT t.*
  FROM
...
INSERT INTO gk_large.comppayment_transaction
  SELECT t.*
  FROM
...
INSERT INTO gk_large.compundeliveredmail
  SELECT DISTINCT m.*
  FROM gk_large.compuser AS u RIGHT JOIN
...
INSERT INTO gk_large.compuseractivity
  SELECT *
  FROM
...
INSERT INTO gk_large.compaffiliate_promotion
  SELECT *
  FROM
...
INSERT INTO gk_large.compaffiliate_promotion_refund
  SELECT *
  FROM
...
INSERT INTO gk_large.compaussehen
  SELECT t.*
...
INSERT INTO gk_large.compext_adjektive
  SELECT *
  FROM
...
INSERT INTO gk_large.compext_freundschaft
  SELECT *
  FROM
...
INSERT INTO gk_large.compext_gesellschaft
  SELECT *
  FROM
...
INSERT INTO gk_large.compext_hobby_e
  SELECT *
...
INSERT INTO gk_large.compext_kritische_lebensereignisse
  SELECT *
  FROM
...
INSERT INTO gk_large.compext_partnerschaft
  SELECT *
  FROM
...
INSERT INTO gk_large.compext_persoenlichkeit
  SELECT *
  FROM
...
INSERT INTO gk_large.compext_stoerbarkeit
  SELECT *
  FROM
...
INSERT INTO gk_large.compffoto
  SELECT *
...
INSERT INTO gk_large.compfreund
  SELECT t.*
...
INSERT INTO gk_large.compfreundschaft
  SELECT t.*
  FROM
...
INSERT INTO gk_large.compftext
  SELECT t.*
...
INSERT INTO gk_large.compgesellschaft
  SELECT t.*
  FROM
...
INSERT INTO gk_large.comphobby_v
  SELECT t.*
...
INSERT INTO gk_large.comppartner
  SELECT t.*
  FROM gleichklang_migration.comppartner AS t
    JOIN gleichklang_migration.users AS u
      ON t.owner = u.no;
SELECT 'comppartner finished';
INSERT INTO gk_large.comppartnerschaft
  SELECT t.*
  FROM
...
INSERT INTO gk_large.comppersoenlichkeit
  SELECT t.*
  FROM
...
INSERT INTO gk_large.compperson
  SELECT t.*
...
INSERT INTO gk_large.comppfoto
  SELECT *
...
INSERT INTO gk_large.compproband_socio_economics
  SELECT *
  FROM
...
INSERT INTO gk_large.compptext
  SELECT t.*
...
INSERT INTO gk_large.compregion_addresslocation
  SELECT *
  FROM
...
INSERT INTO gk_large.compteilnehmerfilterinfo
  SELECT *
  FROM
...
INSERT INTO gk_large.compvorschlag
  SELECT
    DISTINCT
    rubrik,
    suchender,
...
# INSERT INTO gk_large.compmessage
#   SELECT m2.*
#   FROM gk_large.compmessage AS m1 JOIN gleichklang_migration.compmessage AS m2
#       ON m1.reply_message = m2.no
